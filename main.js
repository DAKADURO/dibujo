...
const CATALOG_AIRPIPE = {
    ...
    'tee-red': [
        ...
        { code: '6407', d1: '63mm (2 1/2")', d2: '40mm (1 1/2")', label: '6407: 63mm (2 1/2") x 40mm (1 1/2")', L: '7.87"' },
        { code: '6507', d1: '63mm (2 1/2")', d2: '50mm (2")', label: '6507: 63mm (2 1/2") x 50mm (2")', L: '7.87"' },
        { code: '7407', d1: '80mm (3")', d2: '40mm (1 1/2")', label: '7407: 80mm (3") x 40mm (1 1/2")', L: '8.66"' },
        { code: '7507', d1: '80mm (3")', d2: '50mm (2")', label: '7507: 80mm (3") x 50mm (2")', L: '8.66"' },
        { code: '8507', d1: '100mm (4")', d2: '50mm (2")', label: '8507: 100mm (4") x 50mm (2")', L: '10.31"' },
        { code: '7607', d1: '80mm (3")', d2: '63mm (2 1/2")', label: '7607: 80mm (3") x 63mm (2 1/2")', L: '8.66"' },
        { code: '8607', d1: '100mm (4")', d2: '63mm (2 1/2")', label: '8607: 100mm (4") x 63mm (2 1/2")', L: '10.31"' },
        { code: '8707', d1: '100mm (4")', d2: '80mm (3")', label: '8707: 100mm (4") x 80mm (3")', L: '10.31"' },
        { code: '9607', d1: '150mm (6")', d2: '63mm (2 1/2")', label: '9607: 150mm (6") x 63mm (2 1/2")', L: '13.07"' },
        { code: '9707', d1: '150mm (6")', d2: '80mm (3")', label: '9707: 150mm (6") x 80mm (3")', L: '13.07"' },
        { code: '9807', d1: '150mm (6")', d2: '100mm (4")', label: '9807: 150mm (6") x 100mm (4")', L: '13.07"' },
        { code: 'A607', d1: '200mm (8")', d2: '63mm (2 1/2")', label: 'A607: 200mm (8") x 63mm (2 1/2")', L: '14.76"' },
        { code: 'A707', d1: '200mm (8")', d2: '80mm (3")', label: 'A707: 200mm (8") x 80mm (3")', L: '14.76"' },
        { code: 'A807', d1: '200mm (8")', d2: '100mm (4")', label: 'A807: 200mm (8") x 100mm (4")', L: '14.76"' },
        { code: 'A907', d1: '200mm (8")', d2: '150mm (6")', label: 'A907: 200mm (8") x 150mm (6")', L: '14.76"' }
    ],
    'tee-lat': [
        { code: '8712', d1: '100mm (4")', d2: '80mm (3")', label: '8712: 100mm (4") x 80mm (3")', L: '10.31"' },
        { code: '9712', d1: '150mm (6")', d2: '80mm (3")', label: '9712: 150mm (6") x 80mm (3")', L: '13.07"' },
        { code: '9812', d1: '150mm (6")', d2: '100mm (4")', label: '9812: 150mm (6") x 100mm (4")', L: '13.07"' },
        { code: 'A812', d1: '200mm (8")', d2: '100mm (4")', label: 'A812: 200mm (8") x 100mm (4")', L: '14.76"' },
        { code: 'A912', d1: '200mm (8")', d2: '150mm (6")', label: 'A912: 200mm (8") x 150mm (6")', L: '14.76"' }
    ],
    'quickdrop': [
        // Straight Quick Drop
    ...
    'valvula': [
        ...
        // Threaded Ball Valve (Aluminium) — L from equivalent brass model same-size
        { code: '0073', d1: '25mm (1")', d2: '25mm (1")', label: '0073: 25mm (1") (Alum Ball Valve, Female)', L: '169 mm' },
        { code: '0173', d1: '40mm (1 1/2")', d2: '40mm (1 1/2")', label: '0173: 40mm (1 1/2") (Alum Ball Valve, Female)', L: '232 mm' },
        { code: '1073', d1: '25mm (1")', d2: '25mm (1")', label: '1073: 25mm (1") (Alum Ball Valve, Male)', L: '169 mm' },
        { code: '1173', d1: '40mm (1 1/2")', d2: '40mm (1 1/2")', label: '1173: 40mm (1 1/2") (Alum Ball Valve, Male)', L: '232 mm' },
        { code: '0273', d1: '25mm (1")', d2: '25mm (1")', label: '0273: 25mm (1") (Alum Ball Valve, Male/Female)', L: '169 mm' },
        { code: '1273', d1: '40mm (1 1/2")', d2: '40mm (1 1/2")', label: '1273: 40mm (1 1/2") (Alum Ball Valve, Male/Female)', L: '232 mm' },
        { code: '2073', d1: '25mm (1")', d2: '25mm (1")', label: '2073: 25mm (1") (Alum Ball Valve, Female)', L: '169 mm' },
        { code: '4073', d1: '40mm (1 1/2")', d2: '40mm (1 1/2")', label: '4073: 40mm (1 1/2") (Alum Ball Valve, Female)', L: '232 mm' },
        { code: '5073', d1: '50mm (2")', d2: '50mm (2")', label: '5073: 50mm (2") (Alum Ball Valve, Female)', L: '242 mm' },
        ...
        { code: '6552', d1: '50mm (2")', label: '6552: 50mm (2") (1-port Wall Bracket)', L: '165 mm' },
        ...
        { code: '1352', d1: '20mm (3/4")', label: '1352: 20mm (3/4") (Male QC Valve)', L: '116 mm' },
        { code: '2352', d1: '25mm (1")', label: '2352: 25mm (1") (Male QC Valve)', L: '122 mm' },
        { code: '4352', d1: '40mm (1 1/2")', label: '4352: 40mm (1 1/2") (Male QC Valve)', L: '163 mm' },
        { code: '5352', d1: '50mm (2")', label: '5352: 50mm (2") (Male QC Valve)', L: '177 mm' },
        // Butterfly Valve Pre-Assembled (Cast Iron)
        { code: '6051', d1: '63mm (2 1/2")', label: '6051: 63mm (2 1/2") (Butterfly Valve CI)', L: '188 mm' },
        { code: '7051', d1: '80mm (3")', label: '7051: 80mm (3") (Butterfly Valve CI)', L: '210 mm' },
        { code: '8051', d1: '100mm (4")', label: '8051: 100mm (4") (Butterfly Valve CI)', L: '236 mm' },
        { code: '9051', d1: '150mm (6")', label: '9051: 150mm (6") (Butterfly Valve CI)', L: '256 mm' },
        { code: 'A051', d1: '200mm (8")', label: 'A051: 200mm (8") (Butterfly Valve CI)', L: '278 mm' },
        // Butterfly Valve Pre-Assembled (Stainless Steel)
        { code: '6151', d1: '63mm (2 1/2")', label: '6151: 63mm (2 1/2") (Butterfly Valve SS)', L: '188 mm' },
        { code: '7151', d1: '80mm (3")', label: '7151: 80mm (3") (Butterfly Valve SS)', L: '210 mm' },
        { code: '8151', d1: '100mm (4")', label: '8151: 100mm (4") (Butterfly Valve SS)', L: '236 mm' },
        { code: '9151', d1: '150mm (6")', label: '9151: 150mm (6") (Butterfly Valve SS)', L: '256 mm' },
